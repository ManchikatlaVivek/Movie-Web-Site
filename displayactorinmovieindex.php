...
<body>
    ...
    <form id="qw" action="index.php" method="post">
      ...
      <form id="qww" action="moviesindex.php" method="post">
        <input type="submit" value="Movie Page">
      </form>
</div>
<div id=content1><br>
<form action="displayactorinmovieindex.php" method="post" id=b>
...
<div id=content2>
<br>
<form action="displaydirectorinmovieindex.php" method="post" id=a>
